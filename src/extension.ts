/**
 * Code Architecture Analyzer Extension
...
export function activate(context: vscode.ExtensionContext) {
	console.log('Code Architecture Analyzer extension is now active!');
...
<body>
	<div class="container">
		...
		<footer>
			<p>Generated by <strong>Code Architecture Analyzer</strong> - VS Code Extension</p>
